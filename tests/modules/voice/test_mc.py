...
class TestMc(TestCase):
    def test_mc_say(self):
        ...
        self.assertEqual('testing text2', Mc.say('testing text2').get_request_data()['text'])
    ...
    def test_mc_dial(self):
        ...
        self.assertEqual('testing to2', Mc.dial('testing to2').get_request_data()['to'])
    ...
    def test_mc_play(self):
        ...
        self.assertEqual('testing file2', Mc.play('testing file2').get_request_data()['file'])
